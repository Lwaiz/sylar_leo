...
sylar::ConfigVar<std::unordered_map<std::string, int>>::ptr g_str_int_umap_value_config =
        sylar::Config::Lookup("system.str_int_umap", std::unordered_map<std::string, int>{{"k", 3}}, "system str int umap");
...
#define XX_PM(g_var, prefix) \
    ...
    SYLAR_LOG_INFO(SYLAR_LOG_ROOT()) << "after1: " << g_person_vec_map->toString();
